...
export const BASE_MAP_OPTIONS = function(_mapLayers) {
    ...
    {/* <LayersControl.BaseLayer name="OSM B&W" checked={0 === baseMapSelection}>
      <TileLayer
        ...
        url="s3://long-term.cache.maps.stamen.com/toner/{z}/{x}/{y}.png',"
				opacity={baseMapOpacity}
      />
    </LayersControl.BaseLayer> */}
    <LayersControl.BaseLayer name="OSM"  checked={0 === baseMapSelection}>
      <TileLayer
        attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
    ...
    <LayersControl.BaseLayer name="Aerial Hybrid"  checked={1 === baseMapSelection}>
			<LayerGroup>
				<TileLayer
					attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
